  ...
  if(!$con)
   ...
   if (!isset($_SESSION['driver_username'])) {
	...
	$driver_username = $_SESSION['driver_username'];
        ...
        $driver_contact = $_POST['mono'];
        $driver_email = $_POST['email'];
       $feedback_message = $_POST['message'];		


        $sql2 = "INSERT INTO feedback (driver_username, driver_email, driver_contact, feedback_message) VALUES('$driver_username', '$driver_email', '$driver_contact', '$feedback_message')";
         if (mysqli_query($con,$sql2) === TRUE) {

	       echo "<script>alert(' Driver Feedback successfully.')</script>";  
...
<ul class="menu">
	   ...
	   <li class="menu"><a href="dashboard.php"><i class="fa fa-home" id="nav-image"></i>Driver Profile</a></li>
       <li class="menu"><a href="editaccount.php"><i class="fa fa-home" id="nav-image"></i>Driver EditAccount</a></li>
...
<img src="admin/images/logo.jpeg" height = "170px" class = "logo" style="padding-top:15px; padding-left:10px; padding-right:230px" align = "center">
