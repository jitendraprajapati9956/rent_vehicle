...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST['username']) && empty($_POST['password'])) {
        ...
        $query = "SELECT password FROM driver WHERE driver_username='$username'";
        ...
        if ($newPassword == $confirmPassword) {
            $updateQuery = "UPDATE driver SET driver_password='$newPassword' WHERE driver_username='$username'";
...
<marquee behavior="scroll" scrollamount="18" direction="right"><center><h1 style="font-family: 'Cinzel', serif;"><font color="white">Forgot Password Driver </font></h1></center></marquee>
...
<form action="#" method="post">
  ...
  <a href="driver_login.php">Back to login</a></span>
