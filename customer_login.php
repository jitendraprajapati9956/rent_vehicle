...
<ul class="menu">
 ...
 <marquee behavior="scroll" scrollamount="18" direction="right"><center><h1 style="font-family: 'Cinzel', serif;"><font color="white">Welcome To Customer</font></h1></center></marquee>
...
<div class="form">
  ...
  <div class="container" >
      <a href="customer_forgot.php">Forgot password?</a></span><br>
     <a href="customerregistration.php">New Customer Account</a></span>
  </div>
</form>
</center>
</div>
